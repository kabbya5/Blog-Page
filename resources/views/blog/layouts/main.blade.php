...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/css/blog/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/css/custom.css')}}">
</head>
<body>
    <header>
    ...
    <script src="{{asset('css/blog/js/bootstrap.min.js')}}"></script>
</body>
</html>
